...
WebUI.click(findTestObject('Object Repository/Page_Pengaturan Approval Usulan/a_Rp. 5.000_btn btn-primary'))

WebUI.setText(findTestObject('Object Repository/Page_Update Approval Usulan Tahap 1/input_Nominal Minimal_UnitApprovalnominal_minimal'), 
    '50')

WebUI.click(findTestObject('Object Repository/Page_Update Approval Usulan Tahap 1/button_Simpan Approval'))
