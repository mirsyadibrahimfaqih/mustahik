...
WebUI.click(findTestObject('Object Repository/Page_Database Mustahik YBM PLN/a_Approval Usulan'))

WebUI.click(findTestObject('Object Repository/Page_Pengaturan Approval Usulan/a_Rp. 5.000_btn btn-danger'))
