...
WebUI.setText(findTestObject('Object Repository/Page_Lembaga/input_Nama_nama'), 'tes')

WebUI.click(findTestObject('Object Repository/Page_Lembaga/button_Terapkan Pencarian'))

WebUI.enhancedClick(findTestObject('Object Repository/Page_Lembaga/td_tes'))

WebUI.click(findTestObject('Object Repository/Page_tes/a_Update'))

WebUI.setText(findTestObject('Object Repository/Page_Update Lembaga/input_Nama Lembaga_Lembaganama'), 'tes12')

WebUI.enhancedClick(findTestObject('Object Repository/Page_Update Lembaga/button_Simpan'))
