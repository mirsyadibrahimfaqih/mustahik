...
WebUI.setText(findTestObject('Object Repository/Page_PeTIK MUSTAHIK/input_PeTIK MUSTAHIK_LoginFormcaptcha'), 'kknekav')

WebUI.click(findTestObject('Object Repository/Page_PeTIK MUSTAHIK/button_Masuk'))

WebUI.click(findTestObject('Object Repository/Page_Database Mustahik YBM PLN/path'))
